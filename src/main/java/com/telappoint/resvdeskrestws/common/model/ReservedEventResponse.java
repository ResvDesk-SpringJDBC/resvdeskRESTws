...
public class ReservedEventResponse extends BaseResponse {
	...
	private List<EventHistory> reservedEvents;

	public List<EventHistory> getReservedEvents() {
		return reservedEvents;
	}

	public void setReservedEvents(List<EventHistory> reservedEvents) {
